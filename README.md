...
> 以下圍針對賴祐吉老師所開的電腦圖學導論這門課的注意事項，這份 Github 提供的程式碼可直接用於繳交的專案中。另外，除了此 GitHub 教學文件以外，也有其他人所撰寫的教學文件，非常推薦交互觀看。但是，建議你若參考了該網站，則要將該網站放進你的參考文件列表中，並且，**切勿直接抄襲該網站的程式碼，抓到則視為抄襲者辦理**。
